...
/**
 * This class implements a button listener when the zoom value is decreased 
 * @author Shardul
 */
public class ButtonListenerDec implements ActionListener {
    ...
    */
     ...
     * @param zm 
     */
	public ButtonListenerDec (UserInterface zm)
	{
		this.myZoom = zm;
	}
    /**
